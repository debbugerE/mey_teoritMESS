...
while running:
    ...
    loot_text = font.render(f"Loot: {loot_collected}", True, (255, 255, 255))  # Отрисовка счетчика лута
    screen.blit(lives_text, (50, 50))
    screen.blit(score_text, (680, 50))
    screen.blit(loot_text, (350, 50))  # Расположение счетчика лута
